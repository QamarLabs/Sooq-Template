  ...
  return (
    <footer className=" pb-10 md:px-5 md:pb-20">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="mb-3 flex gap-2 text-sm hover:underline">
              <MailIcon size={16} />
              <Link href="mailto:info@skatersfl.com">info@skatersfl.com</Link>
            </div>
            <div className="mb-3 flex gap-2 text-sm hover:underline">
              <PhoneCallIcon size={16} />
              <Link href="tel:10000000000">10000000000</Link>
            </div>
            <div className="mb-3 flex gap-2 text-sm hover:underline">
              <PhoneCallIcon size={16} />
              <Link href="tel:10000000000">10000000000</Link>
          ...
          <div>
            <h2 className="mb-3 text-xl font-bold">Qamar Labs Inc</h2>
            <a
      ...
      <p className="mt-10 text-center text-sm">
        © {new Date().getFullYear()} skatersfl
      </p>
    </footer>
  );
}
